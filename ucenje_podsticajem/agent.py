...
class AgentQ:
    def __init__(self, state_height, state_width, learning_rate=1, epsilon=0.999, gamma=0.9):
        """
    ...
    def observe(self, state, reward, epoch):
        """
        ...
        if self.train_mode and self.prev_state is not None:
            learning_rate = np.log(epoch + 1) / (epoch + 1) * self.init_learning_rate
